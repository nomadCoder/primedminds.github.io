...
var shakingredheight = 250
var shakingredwidth = 200
redright.hide()
...
var purpleheight = 120
var purplewidth = 97.5
...
var shakingpurpleheight = 250
var shakingpurplewidth = 200
purpleright.hide()
...
var orangeheight = 120
var orangewidth = 97.5
...
var shakingorangeheight = 250
var shakingorangewidth = 200
orangeright.hide()
...
var shakinggreenheight = 250
var shakinggreenwidth = 200
greenright.hide()
...
var shakingblueheight = 250
var shakingbluewidth = 200
blueright.hide()
...
var shakingblackheight = 250
var shakingblackwidth = 200
blackright.hide()
...
var shakingbandwheight = 250
var shakingbandwwidth = 200
bandwright.hide()
...
var dragto = (input1) => {
  input1.x = mouseX
  input1.y = mouseY
  input1.height = (-1 * mouseY) + 300
  input1.width = (-1 * mouseY) + 300
}
var drop = (input1, input2, input3, input4, input5) => {
...
var macrodd = (input1, input2, input3, input4, input5, input6, input7, input8, input9) => {
  //drag function
  ...
  if (input1.distanceTo(rightpedestal) < 100 && !mouseDown) {
    drop(input1, rightpedestal, input3, input8, input9)
    ontheright = input2
    currentlydragging = null
  }
  //drops at left pedestal
  if (input1.distanceTo(leftpedestal) < 100 && !mouseDown) {
    drop(input1, leftpedestal, input4, input8, input9)
    ontheleft = input2
    currentlydragging = null
  }
  //if not close enough to either pedestal, returns the monster home
  if (input1.distanceTo(rightpedestal) > 100 && (input1.distanceTo(leftpedestal) > 100) && !(input1.touching(input4)) && !(mouseDown)) {
    sendhome(input1, input5, input4, input6, input7)
    currentlydragging = null
  }
}
...
forever(() => {
  if ((currentlydragging != "bandw") && (currentlydragging != "blue") && (currentlydragging != "green") && (currentlydragging != "orange") && (currentlydragging != "purple") && (currentlydragging != "red")) {
    macrodd(blackstanding, "black", blackright, blackleft, blackhome, blackheight, blackwidth, shakingblackheight, shakingblackwidth)
  }
  if ((currentlydragging != "black") && (currentlydragging != "blue") && (currentlydragging != "green") && (currentlydragging != "orange") && (currentlydragging != "purple") && (currentlydragging != "red")) {
    macrodd(bandwstanding, "bandw", bandwright, bandwleft, bandwhome, bandwheight, bandwwidth, shakingbandwheight, shakingbandwwidth)
  }
  if ((currentlydragging != "black") && (currentlydragging != "bandw") && (currentlydragging != "green") && (currentlydragging != "orange") && (currentlydragging != "purple") && (currentlydragging != "red")) {
    macrodd(bluestanding, "blue", blueright, blueleft, bluehome, blueheight, bluewidth, shakingblueheight, shakingbluewidth)
  }
  if ((currentlydragging != "black") && (currentlydragging != "bandw") && (currentlydragging != "blue") && (currentlydragging != "orange") && (currentlydragging != "purple") && (currentlydragging != "red")) {
    macrodd(greenstanding, "green", greenright, greenleft, greenhome, greenheight, greenwidth, shakinggreenheight, shakinggreenwidth)
  }
  if ((currentlydragging != "black") && (currentlydragging != "bandw") && (currentlydragging != "blue") && (currentlydragging != "green") && (currentlydragging != "purple") && (currentlydragging != "red")) {
    macrodd(orangestanding, "orange", orangeright, orangeleft, orangehome, orangeheight, orangewidth, shakingorangeheight, shakingorangewidth)
  }
  if ((currentlydragging != "black") && (currentlydragging != "bandw") && (currentlydragging != "blue") && (currentlydragging != "green") && (currentlydragging != "orange") && (currentlydragging != "red")) {
    macrodd(purplestanding, "purple", purpleright, purpleleft, purplehome, purpleheight, purplewidth, shakingpurpleheight, shakingpurplewidth)
  }
  if ((currentlydragging != "black") && (currentlydragging != "bandw") && (currentlydragging != "blue") && (currentlydragging != "green") && (currentlydragging != "orange") && (currentlydragging != "purple")) {
    macrodd(redstanding, "red", redright, redleft, redhome, redheight, redwidth, shakingredheight, shakingredwidth)
  }
})
...
var sendhome = (input1, input2, input3, input4, input5) => {
  input3.hide()
  input1.show()
  input1.x = input2.x - 10
  input1.y = maxY - 60
  input1.height = input4
  input1.width = input5
  if (input1 === bluestanding) {
    bluestanding.y = maxY - 50
  }
  if (input1 === bandwstanding) {
    bandwstanding.y = maxY - 47
  }
}
...
sendbutton.onMouseDown(() => {
  if (ontheleft === "black") {
    sendhome(blackstanding, blackhome, blackleft, blackheight, blackwidth)
  }
  if (ontheright === "black") {
    sendhome(blackstanding, blackhome, blackright, blackheight, blackwidth)
  }
  if (ontheleft === "bandw") {
    sendhome(bandwstanding, bandwhome, bandwleft, bandwheight, bandwwidth)
  }
  if (ontheright === "bandw") {
    sendhome(bandwstanding, bandwhome, bandwright, bandwheight, bandwwidth)
  }
  if (ontheleft === "blue") {
    sendhome(bluestanding, bluehome, blueleft, blueheight, bluewidth)
  }
  if (ontheright === "blue") {
    sendhome(bluestanding, bluehome, blueright, blueheight, bluewidth)
  }
  if (ontheright === "green") {
    sendhome(greenstanding, greenhome, greenright, greenheight, greenwidth)
  }
  if (ontheleft === "green") {
    sendhome(greenstanding, greenhome, greenleft, greenheight, greenwidth)
  }
  if (ontheright === "orange") {
    sendhome(orangestanding, orangehome, orangeright, orangeheight, orangewidth)
  }
  if (ontheleft === "orange") {
    sendhome(orangestanding, orangehome, orangeleft, orangeheight, orangewidth)
  }
  if (ontheright === "purple") {
    sendhome(purplestanding, purplehome, purpleright, purpleheight, purplewidth)
  }
  if (ontheleft === "purple") {
    sendhome(purplestanding, purplehome, purpleleft, purpleheight, purplewidth)
  }
  if (ontheright === "red") {
    sendhome(redstanding, redhome, redright, redheight, redwidth)
  }
  if (ontheleft === "red") {
    sendhome(redstanding, redhome, redleft, redheight, redwidth)
  }
})

//eliminated a lot of code
var macroshake = (input1, input2, input3, input4, input5, input6, input7, input8) => {
  shake(input1, input2, input3, input4)
  after(3.5, "seconds", () => {
    sendhome(input5, input6, input1, input7, input8)
  })
}
  ...
  if ((ontheleft === null && ontheright != null) || (ontheright === null && ontheleft != null)) {
    ...
    if (ontheleft === "black") {
      if ((ontheright === "bandw" && blackandbandw === "done") || (ontheright === "blue" && blackandblue === "done") || (ontheright === "green" && blackandgreen === "done") || (ontheright === "orange" && blackandorange === "done") || (ontheright === "purple" && blackandpurple === "done") || (ontheright === "red" && blackandred === "done")) {
        ...
        macroshake(blackleft, blackld, blacklu, blacklefturl, blackstanding, blackhome, blackheight, blackwidth)
        blackshakes += 1
      }
    }
    if (ontheright === "black") {
      if ((ontheleft === "bandw" && blackandbandw === "done") || (ontheleft === "blue" && blackandblue === "done") || (ontheleft === "green" && blackandgreen === "done") || (ontheleft === "orange" && blackandorange === "done") || (ontheleft === "purple" && blackandpurple === "done") || (ontheleft === "red" && blackandred === "done")) {
        ...
        macroshake(blackright, blackrd, blackru, blackrighturl, blackstanding, blackhome, blackheight, blackwidth)
        blackshakes += 1
      }
    }
    if (ontheleft === "bandw") {
      if ((ontheright === "black" && blackandbandw === "done") || (ontheright === "blue" && blueandbandw === "done") || (ontheright === "green" && bandwandgreen === "done") || (ontheright === "orange" && bandwandorange === "done") || (ontheright === "purple" && bandwandpurple === "done") || (ontheright === "red" && bandwandred === "done")) {
        ...
        macroshake(bandwleft, bandwld, bandwlu, bandwlefturl, bandwstanding, bandwhome, bandwheight, bandwwidth)
        bandwshakes += 1
      }
    }
    if (ontheright === "bandw") {
      if ((ontheleft === "black" && blackandbandw === "done") || (ontheleft === "blue" && blueandbandw === "done") || (ontheleft === "green" && bandwandgreen === "done") || (ontheleft === "orange" && bandwandorange === "done") || (ontheleft === "purple" && bandwandpurple === "done") || (ontheleft === "red" && bandwandred === "done")) {
        ...
        macroshake(bandwright, bandwrd, bandwru, bandwrighturl, bandwstanding, bandwhome, bandwheight, bandwwidth)
        bandwshakes += 1
      }
    }
    if (ontheleft === "blue") {
      if ((ontheright === "black" && blackandblue === "done") || (ontheright === "bandw" && blueandbandw === "done") || (ontheright === "green" && blueandgreen === "done") || (ontheright === "orange" && blueandorange === "done") || (ontheright === "purple" && blueandpurple === "done") || (ontheright === "red" && blueandred === "done")) {
        ...
        macroshake(blueleft, blueld, bluelu, bluelefturl, bluestanding, bluehome, blueheight, bluewidth)
        blueshakes += 1
      }
    }
    if (ontheright === "blue") {
      if ((ontheleft === "black" && blackandblue === "done") || (ontheleft === "bandw" && blueandbandw === "done") || (ontheleft === "green" && blueandgreen === "done") || (ontheleft === "orange" && blueandorange === "done") || (ontheleft === "purple" && blueandpurple === "done") || (ontheleft === "red" && blackandred === "done")) {
        ...
        macroshake(blueright, bluerd, blueru, bluerighturl, bluestanding, bluehome, blueheight, bluewidth)
        blueshakes += 1
      }
    }
    if (ontheright === "green") {
      if ((ontheleft === "black" && blackandgreen === "done") || (ontheleft === "bandw" && bandwandgreen === "done") || (ontheleft === "blue" && blueandgreen === "done") || (ontheleft === "orange" && greenandorange === "done") || (ontheleft === "purple" && greenandpurple === "done") || (ontheleft === "red" && greenandred === "done")) {
        ...
        macroshake(greenright, greenrd, greenru, greenrighturl, greenstanding, greenhome, greenheight, greenwidth)
        greenshakes += 1
      }
    }
    if (ontheleft === "green") {
      if ((ontheright === "black" && blackandgreen === "done") || (ontheright === "bandw" && bandwandgreen === "done") || (ontheright === "blue" && blueandgreen === "done") || (ontheright === "orange" && greenandorange === "done") || (ontheright === "purple" && greenandpurple === "done") || (ontheright === "red" && greenandred === "done")) {
        ...
        macroshake(greenleft, greenld, greenlu, greenlefturl, greenstanding, greenhome, greenheight, greenwidth)
        greenshakes += 1
      }
    }
    if (ontheright === "orange") {
      if ((ontheleft === "black" && blackandorange === "done") || (ontheleft === "bandw" && bandwandorange === "done") || (ontheleft === "blue" && blueandorange === "done") || (ontheleft === "green" && greenandorange === "done") || (ontheleft === "purple" && orangeandpurple === "done") || (ontheleft === "red" && orangeandred === "done")) {
        ...
        macroshake(orangeright, orangerd, orangeru, orangerighturl, orangestanding, orangehome, orangeheight, orangewidth)
        orangeshakes += 1
      }
    }
    if (ontheleft === "orange") {
      if ((ontheright === "black" && blackandorange === "done") || (ontheright === "bandw" && bandwandorange === "done") || (ontheright === "blue" && blueandorange === "done") || (ontheright === "green" && greenandorange === "done") || (ontheright === "purple" && orangeandpurple === "done") || (ontheright === "red" && orangeandred === "done")) {
        ...
        macroshake(orangeleft, orangeld, orangelu, orangelefturl, orangestanding, orangehome, orangeheight, orangewidth)
        orangeshakes += 1
      }
    }
    if (ontheright === "purple") {
      if ((ontheleft === "black" && blackandpurple === "done") || (ontheleft === "bandw" && bandwandpurple === "done") || (ontheleft === "blue" && blueandpurple === "done") || (ontheleft === "green" && greenandpurple === "done") || (ontheleft === "orange" && orangeandpurple === "done") || (ontheleft === "red" && purpleandred === "done")) {
        ...
        macroshake(purpleright, purplerd, purpleru, purplerighturl, purplestanding, purplehome, purpleheight, purplewidth)
        purpleshakes += 1
      }
    }
    if (ontheleft === "purple") {
      if ((ontheright === "black" && blackandpurple === "done") || (ontheright === "bandw" && bandwandpurple === "done") || (ontheright === "blue" && blueandpurple === "done") || (ontheright === "green" && greenandpurple === "done") || (ontheright === "orange" && orangeandpurple === "done") || (ontheright === "red" && purpleandred === "done")) {
        ...
        macroshake(purpleleft, purpleld, purplelu, purplelefturl, purplestanding, purplehome, purpleheight, purplewidth)
        purpleshakes += 1
      }
    }
    if (ontheright === "red") {
      if ((ontheleft === "black" && blackandred === "done") || (ontheleft === "bandw" && bandwandred === "done") || (ontheleft === "blue" && blueandred === "done") || (ontheleft === "green" && greenandred === "done") || (ontheleft === "orange" && orangeandred === "done") || (ontheleft === "purple" && purpleandred === "done")) {
        ...
        macroshake(redright, redrd, redru, redrighturl, redstanding, redhome, redheight, redwidth)
        redshakes += 1
      }
    }
    if (ontheleft === "red") {
      if ((ontheright === "black" && blackandred === "done") || (ontheright === "bandw" && bandwandred === "done") || (ontheright === "blue" && blueandred === "done") || (ontheright === "green" && greenandred === "done") || (ontheright === "orange" && orangeandred === "done") || (ontheright === "purple" && purpleandred === "done")) {
        ...
        macroshake(redleft, redld, redlu, redlefturl, redstanding, redhome, redheight, redwidth)
        redshakes += 1
      }
    }
  }
